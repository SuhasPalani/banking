...
import BankUser from './pages/BankUser';
import './App.css';
...
function Main() {
  ...
  return (
    <div className="app">
      ...
      {location.pathname !== '/bankuser' && location.pathname !== '/banking' && location.pathname !== '/admin' && location.pathname !== '/admin_console' &&(
        <nav className="main-nav">
          ...
          <div className="nav-links">
            ...
            <Link to="/bankuser" className="nav-btn primary">BankUser</Link>
          </div>
        </nav>
      )}
